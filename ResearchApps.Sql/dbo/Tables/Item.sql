CREATE TABLE [dbo].[Item] (
    ...
    CONSTRAINT [FK_dbo.Item_dbo.ItemGroup01_ItemGroup01Id] FOREIGN KEY ([ItemGroup01Id]) REFERENCES [dbo].[ItemGroup01] ([ItemGroup01Id]),
    CONSTRAINT [FK_dbo.Item_dbo.ItemGroup02_ItemGroup02Id] FOREIGN KEY ([ItemGroup02Id]) REFERENCES [dbo].[ItemGroup02] ([ItemGroup02Id]),
