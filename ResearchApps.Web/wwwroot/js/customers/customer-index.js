/**
 * Customer Index Page Component
 * Handles listing, filtering, sorting, and pagination of customers with HTMX
 */
    ...
    return {
        ...
        init() {
            ...
            document.body.addEventListener('htmx:beforeRequest', (e) => {
                if (e.detail.target && e.detail.target.id === 'customer-list-container') {
                    this.isLoading = true;
                }
            });
        ...
        /**
         * Fetch customer list with current filters, sorting, and pagination
        ...
        fetchList(page = 1) {
            ...
            // Use htmx to fetch
            htmx.ajax('GET', url, {
                target: '#customer-list-container',
                swap: 'innerHTML',
        ...
        /**
         * Export customers to Excel with current filters and sorting
        ...
        async exportToExcel() {
            ...
            try {
                ...
                console.error('[Customer Index] Export error:', error);
