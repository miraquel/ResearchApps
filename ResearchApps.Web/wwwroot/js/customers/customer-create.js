    ...
    return {
        ...
        initTopSelect() {
            try {
                this.topSelect = new TomSelect('#topSelect', {
                    ...
                    load: async (query, callback) => {
                        try {
                            ...
                            console.error('[Customer Create] Error loading TOP data:', error);
                ...
                console.log('[Customer Create] TomSelect initialized successfully');
            } catch (error) {
                console.error('[Customer Create] Error initializing TomSelect:', error);
                if (typeof showError === 'function') {
...
window.customerCreate = customerCreate;
