/**
 * ItemGroup02 Edit Page Component
 * @param {number|null} initialStatusId - Pre-selected Status ID
 * @returns {Object} Alpine.js component
 */
function itemgroup02Edit(initialStatusId = null) {
    return {
        statusSelect: null,
        ...
        initStatusSelect() {
            ...
            try {
                this.statusSelect = new TomSelect('#StatusId', {
                    ...
                    load: async (query, callback) => {
                        try {
                            ...
                            console.error('[ItemGroup02 Edit] Error loading Status:', error);
                            callback();
                        }
                    },
                ...
                console.error('[ItemGroup02 Edit] Error initializing Status TomSelect:', error);
            }
        }
    };
}

window.itemgroup02Edit = itemgroup02Edit;
