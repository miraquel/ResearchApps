 ...
 */
function locationEdit(initialStatusId = null) {
    return {
        statusSelect: null,
        ...
        initStatusSelect() {
            ...
            try {
                this.statusSelect = new TomSelect('#StatusId', {
                    ...
                    load: async (query, callback) => {
                        try {
                            ...
                            console.error('[Location Edit] Error loading Status:', error);
                            callback();
                        }
                    },
                ...
                console.error('[Location Edit] Error initializing Status TomSelect:', error);
            }
        }
    };
}

window.locationEdit = locationEdit;
