/**
 * Item Index Page Component
 * Handles listing, filtering, sorting, and pagination of items with HTMX
 */
function itemIndex() {
    return {
        isLoading: false,
        ...
        init() {
            ...
            document.body.addEventListener('htmx:beforeRequest', (e) => {
                if (e.detail.target && e.detail.target.id === 'item-list-container') {
                    this.isLoading = true;
                }
            });
        ...
        /**
         * Fetch item list with current filters, sorting, and pagination
        ...
        fetchList(page = 1) {
            ...
            const url = `/Items/List?${params.toString()}`;
            
            // Use htmx to fetch
            htmx.ajax('GET', url, {
                target: '#item-list-container',
                swap: 'innerHTML',
        ...
        /**
         * Export items to Excel with current filters and sorting
        ...
        async exportToExcel() {
            ...
            try {
                ...
                console.error('[Item Index] Export error:', error);
